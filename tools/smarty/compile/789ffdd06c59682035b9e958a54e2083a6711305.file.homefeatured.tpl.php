<?php /* Smarty version Smarty-3.0.7, created on 2012-10-04 02:47:39
         compiled from "C:\xampp\htdocs\clopstore/themes/leo_tshirt/modules/homefeatured/homefeatured.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30389506cdcab311498-19357966%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '789ffdd06c59682035b9e958a54e2083a6711305' => 
    array (
      0 => 'C:\\xampp\\htdocs\\clopstore/themes/leo_tshirt/modules/homefeatured/homefeatured.tpl',
      1 => 1349280130,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30389506cdcab311498-19357966',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_function_math')) include 'C:\xampp\htdocs\clopstore\tools\smarty\plugins\function.math.php';
if (!is_callable('smarty_modifier_escape')) include 'C:\xampp\htdocs\clopstore\tools\smarty\plugins\modifier.escape.php';
?>
...
"><?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['name'],27,'...'),'htmlall','UTF-8');?>
					...
					<div class="product_desc"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value['description_short']),130,'...');?>
</div>
...
"><?php echo smartyTranslate(array('s'=>'Add to cart','mod'=>'homefeatured'),$_smarty_tpl);?>
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['product']->value['show_price']&&!isset($_smarty_tpl->getVariable('restricted_country_mode',null,true,false)->value)&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?><p class="price_container"><span class="price lof-price-fix"><?php if (!$_smarty_tpl->getVariable('priceDisplay')->value){?><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value['price']),$_smarty_tpl);?>
