<?php /* Smarty version Smarty-3.0.7, created on 2012-10-03 20:01:44
         compiled from "C:\xampp\htdocs\clopstore/themes/leo_tshirt/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:23803506c7d882f9dd6-29789356%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e292e7a235472d418078a792eac6a08b6998707' => 
    array (
      0 => 'C:\\xampp\\htdocs\\clopstore/themes/leo_tshirt/product.tpl',
      1 => 1349280132,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '23803506c7d882f9dd6-29789356',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_math')) include 'C:\xampp\htdocs\clopstore\tools\smarty\plugins\function.math.php';
if (!is_callable('smarty_function_counter')) include 'C:\xampp\htdocs\clopstore\tools\smarty\plugins\function.counter.php';
?>
...
<?php }?>
				...
				<?php if ($_smarty_tpl->getVariable('product')->value->specificPrice&&$_smarty_tpl->getVariable('product')->value->specificPrice['reduction_type']=='percentage'){?>
					<p id="reduction_percent"><?php echo smartyTranslate(array('s'=>'(-'),$_smarty_tpl);?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['group_attribute']->value,'htmlall','UTF-8');?>
			...
			<!-- availability -->
			<p id="availability_statut"<?php if (($_smarty_tpl->getVariable('product')->value->quantity==0&&!$_smarty_tpl->getVariable('product')->value->available_later)||($_smarty_tpl->getVariable('product')->value->quantity!=0&&!$_smarty_tpl->getVariable('product')->value->available_now)||!$_smarty_tpl->getVariable('product')->value->available_for_order||$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?> style="display: none;"<?php }?>>
...
<?php }?>
			...
			<?php if (($_smarty_tpl->getVariable('product')->value->quantity<=$_smarty_tpl->getVariable('last_qties')->value||isset($_smarty_tpl->getVariable('combination',null,true,false)->value['list']))){?>
			<p id="pQuantityAvailable"<?php if ($_smarty_tpl->getVariable('display_qties')->value!=1||$_smarty_tpl->getVariable('product')->value->quantity<=0||!$_smarty_tpl->getVariable('product')->value->available_for_order||$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?> style="display: none;"<?php }?>>
		...
		<!--	<p class="warning_inline" id="last_quantities"<?php if (($_smarty_tpl->getVariable('product')->value->quantity>$_smarty_tpl->getVariable('last_qties')->value||$_smarty_tpl->getVariable('product')->value->quantity==0)||$_smarty_tpl->getVariable('allow_oosp')->value||!$_smarty_tpl->getVariable('product')->value->available_for_order||$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?> style="display: none;"<?php }?> ><?php echo smartyTranslate(array('s'=>'Warning: Last items in stock!'),$_smarty_tpl);?>
			...
			<p id="quantity_wanted_p"<?php if ((!$_smarty_tpl->getVariable('allow_oosp')->value&&$_smarty_tpl->getVariable('product')->value->quantity==0)||$_smarty_tpl->getVariable('virtual')->value||!$_smarty_tpl->getVariable('product')->value->available_for_order||$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?> style="display: none;"<?php }?>>
				<strong><?php echo smartyTranslate(array('s'=>'Quantity :'),$_smarty_tpl);?>
</strong>
...
<?php }?></span><?php }?>
                              ...
                              <p class="product_accessories_button">   
...
"><?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
								...
								<?php if ($_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->getVariable('restricted_country_mode',null,true,false)->value)&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?><a class="exclusive button ajax_add_to_cart_button" href="<?php echo $_smarty_tpl->getVariable('link')->value->getPageLink('cart.php');?>
