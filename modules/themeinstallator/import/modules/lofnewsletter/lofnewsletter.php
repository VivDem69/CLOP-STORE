...
class Lofnewsletter extends Module
{
 	public function __construct()
 	{
 	 	$this->name = 'lofnewsletter';
 	 	$this->tab = 'front_office_features';
		$this->need_instance = 0;

	 	parent::__construct();

 	 	$this->displayName = $this->l('Lof newsletter');
 	...
 	{
 	 	if (parent::install() == false OR $this->registerHook('footer') == false OR $this->registerHook('header') == false)
 	 		return false;
	...
	function hookRightColumn($params)
	{
 	...
 	function hookFooter($params)
 	{
		...
		$smarty->assign('this_path', $this->_path);
 	 	return $this->display(__FILE__, 'lofnewsletter.tpl');
 	}
	...
	{
		Tools::addCSS(($this->_path).'lofnewsletter.css', 'all');
	}
}
