    ...
    <script type="text/javascript">            
    	jQuery(document).ready(function() {ldelim}	
    		jQuery("#lof-content-main-featured-{$moduleId}").SliderNew({ldelim}
                prevId: 'lof-prev-new-{$moduleId}',         			 
                nextId: 'lof-next-new-{$moduleId}',
                catId: 'featured',
                numeric: {$controls_btn_show},
    ...
    <div id="lof-tabs-{$moduleId}-featured" class="lof-content-tab lof-content-tab-{$moduleId}">
        ...
        {if (!empty($loflistFeatureds[0]))}
            <ul class="lof-content-main">
                    ...
                    <li class="lof-main-item" style="width:{$module_width-20}px;">
                            {foreach from=$lists key=i item=item}                             
                            <div class="lof-content-main-item {if ($i+1) % $limitnumcols== 0}lastitem{/if}"  style="width:{$itemWidth}%">
                                <div class="bd-lof-content ajax_block_product clearfix" style="text-align:center;margin:0 auto;">
                                        ...
                                        <div class="lof-box-tools-featured lof-box-tools">
                                            <div class="product_label lof-tool-item lof-tool-item-{$moduleId}" style="height:{$thumbmainHeight}px;width:{$thumbmainWidth}px;">
                                                ...
                                                <div class="lof-content-tools-text">
                                                    ...
                                                    <div class="box-detail"><a href="{$item.link}">{l s='Detail' mod='lofnewproduct'}</a></div>
                                   ...
                                   <div class="lof-item-content">
                                        ...
                                        <span class="lof-price-contain">
                                            <span class="lof-price"><strong>{$item.price}</strong></span>
                            			</span>
										{/if}
										 <a class="view" href="{$item.link}">{l s='Detail' mod='lofnewproduct'}</a>
            ...
            {else}
            <div>{l s='Has not products featured' mod='lofnewproduct'}</div>
            <div class="clr clearfix"></div>
        {/if}
        </div>
    </div>