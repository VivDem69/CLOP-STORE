                    ...
                    <li style="height:{$thumbmainHeight}px;" class="ajax_product first_item clearfix">
                        ...
                        <div class="lof-top-caption lof-top-caption-{$moduleId}" style="width:{$captionWidth}px;">
                            ...
                            {if $showAddCart == 1 AND $source == 'product'}
                                ...
                                <a class="button lof-caption-addcart-top ajax_add_to_cart_button exclusive" rel="ajax_id_product_{$row.id_product}" href="{$site_url}cart.php?add&amp;id_product={$row.id_product}&amp;token={$token}" title="{l s='Add to cart'}">{l s='Add to cart'}</a>
                                {else}
