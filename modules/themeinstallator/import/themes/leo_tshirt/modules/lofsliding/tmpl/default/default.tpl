    ...
    <div class="lof-slidingcaption-wrap {$theme} lof-sliding-{$lofiso_code} clearfix" style="width:{$moduleWidth}px;height:{$moduleHeight+16}px;margin:0 auto;">
    ...
    <div class="clearfix"></div>
    <div style="width:{$smodulePageWidth}px;height:{$smoduleHeight+50}px;margin:0 auto;">
        <div id="lof-slidingtabs-module-{$moduleId}">
            ...
            <div class="lof-tabnews-content">
                ...
                <div id="lof-tabs-{$moduleId}-manufact" class="lof-content-tab lof-content-tab-{$moduleId}">
                    <div class="lof-slidingcaption-wrap {$stheme} lof-sliding-{$lofiso_code} clearfix" style="width:{$smodulePageWidth}px;height:{$smoduleHeight}px;margin:0 auto;">
                		<div class="lof-sliding-features clearfix">
                            <!-- sliding buttons -->
                            {if count($mpages)>1}
                    		<div class="sliding-buttons-same">
