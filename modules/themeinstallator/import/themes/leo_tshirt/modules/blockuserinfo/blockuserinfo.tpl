...
<div id="header_user">
	...
	<p id="header_user_info">		
		{if $cookie->isLogged()}
			...
			(<a class="logout" href="{$link->getPageLink('index.php')}?mylogout" title="{l s='Log me out' mod='blockuserinfo'}">{l s='Log out' mod='blockuserinfo'}</a>)
		{else}
			<a href="{$link->getPageLink('my-account.php', true)}">{l s='Log in' mod='blockuserinfo'}</a>
			<a href="{$link->getPageLink('my-account.php', true)}">{l s='Register' mod='blockuserinfo'}</a>
			<a href="{$link->getPageLink('mywishlist.php', true)}">{l s='My Wishlist' mod='blockuserinfo'}</a>
